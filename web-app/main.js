...
const update_grid = function () {
    ...
    const player_score=game.score.score;
    const player_level=Score.level(game.score);
    const player_lines=game.score.lines_cleared;
    el("player_score").textContent =player_score;
    el("player_level").textContent =player_level;
    el("player_lines").textContent =player_lines;
